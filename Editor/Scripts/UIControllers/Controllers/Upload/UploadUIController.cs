...
namespace Pckgs
{
    public class UploadUIController : UIController
    {
        ...
        private readonly List<ProjectPackageUIController> packageUIControllers = new();
        ...
        void Refresh()
        {
            ...
            {
                var controller = PckgsWindow.ProjectPackageUIAsset.CloneTree<ProjectPackageUIController>(PackageList);
